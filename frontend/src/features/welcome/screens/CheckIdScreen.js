...
import { Controller, useController, useForm, handleSubmit } from 'react-hook-form';
import { Alert, TouchableWithoutFeedback, Keyboard, ScrollView, StyleSheet, View, Text, Image} from 'react-native';
