...
export const SingleProductScreen = ({ route }) => {
	// const { item, userLatitude, userLongitude, distanceKm, description } = route.params;
	...
	console.log(route.params.item.description.photos);
	const fakeItem = {
		ownerId: '12345',
		...
		prices: {
			day: route.params.item.prices.pricePerDay,
			week: 90,
			month: 300,
		},
		caution: 50,
			...
			<KeyboardAvoidingView style={{ flex: 1 }} behavior="padding">
				<View style={styles.container}>
					...
					<View style={styles.imageContainer}>
						...
						{/* <Image source={{ uri: fakeItem.photos }} style={styles.image} /> */}
						...
						<View style={styles.infoContainer}>
							...
							<View style={styles.infoRow}>
								...
								<TouchableOpacity onPress={() => console.log('Nelson clicked')}>
									<Text style={styles.linkText}>Nelson {fakeItem.ownerId}</Text>
								</TouchableOpacity>
							</View>
							<View style={styles.infoRow}>
